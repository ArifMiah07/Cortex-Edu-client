...
export default function Home() {
  return (
    ...
    <>
      ...
      <section className="w-full min-h-[55vh] bg-teal-100 border border-amber-200 p-12">
          <div className=" w-[450px] flex flex-col bg-white p-6 border border-gray-300 drop-shadow-lg ">
            <div className="flex flex-col gap-3">
              <h1 className="text-black text-3xl font-semibold ">Master tomorrow&apos;s skills today</h1>
              <p>
            ...
            <div className="flex gap-5 mt-4 ">
              <button className="text-white font-semibold hover:bg-purple-500 border border-purple-500 bg-purple-700 rounded-sm px-5 py-3  " >Try it free</button>
              <button className="text-purple-700 font-semibold hover:bg-purple-100 border border-purple-500  rounded-sm px-5 py-3  " >Learn AI</button>
            </div>
          </div>
          <div></div>
          <div></div>
